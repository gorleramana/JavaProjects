...
public class UserDetails2 {
	...
	private int userId;
	/**
	 * In Hibernate object support multiple states. Transient state is one of them,
	 * an object with the transient state will never be added to the database and it
	 * has no persistence representation in hibernate session. A Transient state
	 * object is destroyed through garbage collections after an application is
	 * closed
	 */
